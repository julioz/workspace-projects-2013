...
public class RobotoTextView extends TextView {
	 ...
	 *            access the current theme, resources, etc.
	 * @param typeface
	 * 			  The typeface to be used in this view
	 */
	public RobotoTextView(Context context, int typeface) {
		super(context);
		setTypeface(obtaintTypeface(context, typeface));
	}
	...
	private Typeface createTypeface(Context context, int typefaceValue)
		...
		case ROBOTO_CONDENSED:
			typeface = Typeface.createFromAsset(context.getAssets(),
					"fonts/Roboto-CondensedRegular.ttf");
			break;
