	...
	public final String[] get(String url) {
		...
		try {
			...
			if (entity != null) {
				...
				instream.close();
				Log.i(Constants.TAG, "Result from post JsonPost : " + result[0] + " : " + result[1]);
			}
		} catch (Exception e) {
			Log.e(Constants.TAG, "Falha ao acessar Web service", e);
			result[0] = "0";
	...
	public final String[] post(String url, String json) {
		...
		try {
			...
			if (entity != null) {
				...
				result[1] = toString(instream);
				instream.close();
				Log.d(Constants.TAG, "Result from post JsonPost : " + result[0] + " : " + result[1]);
			}
