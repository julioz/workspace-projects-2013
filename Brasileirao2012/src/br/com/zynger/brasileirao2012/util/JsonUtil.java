...
public class JsonUtil {
	...
	public static JSONArray createThirdDivisionRankingJson(SparseArray<ArrayList<Club>> array){
		JSONArray object = new JSONArray();
		for (int i = 0; i < array.size(); i++) {
			JSONArray group = new JSONArray();
			for (Club club : array.valueAt(i)) {
				group.put(club.toThirdDivisionJson());
			}
			object.put(group);
		}
		return object;
