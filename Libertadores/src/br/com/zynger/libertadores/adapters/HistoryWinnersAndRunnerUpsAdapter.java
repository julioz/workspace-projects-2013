...
public class HistoryWinnersAndRunnerUpsAdapter extends ArrayAdapter<HistoricClub> implements OnClickListener {

	private final LayoutInflater mInflater;
	private static final int LAYOUTRESOURCEID = R.layout.history_winnersandrunnerupsrow;
	private ArrayList<HistoricClub> objects;
	
	private String TEXT_PREFIX_WON;
	private String TEXT_PREFIX_RUNNER_UP;
	
	public HistoryWinnersAndRunnerUpsAdapter(Context context, ArrayList<HistoricClub> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row == null){
            ...
            holder.tvWonYears.setVisibility(View.VISIBLE);
            holder.tvRunnerUpYears.setVisibility(View.VISIBLE);
