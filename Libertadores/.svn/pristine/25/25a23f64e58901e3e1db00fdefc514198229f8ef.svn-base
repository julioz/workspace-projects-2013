...
public class ClubSelectorAdapter extends ArrayAdapter<Club>{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String clubName = club.getName().toUpperCase(Locale.getDefault());
        holder.ivBadge.setImageBitmap(BitmapOptimisator.decodeSampledBitmapFromResource(
				getContext().getResources(), badgeRes, 75, 75));
