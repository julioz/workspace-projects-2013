...
public class JsonUtil {
	...
	public static JSONArray createMatchesJson(ArrayList<Match> matches){
		JSONArray array = new JSONArray();
		for (Match match : matches) {
			JSONArray data = match.toJson();
			array.put(data);
		}
		return array;
	}
	...
	public static JSONObject createRostersJson(HashMap<String, ArrayList<Person>> map){
		try{			
			JSONObject object = new JSONObject();
			for(TreeMap.Entry<String, ArrayList<Person>> entry : map.entrySet()) {
