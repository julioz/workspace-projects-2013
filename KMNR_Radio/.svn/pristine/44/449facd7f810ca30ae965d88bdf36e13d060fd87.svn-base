...
public class StatefulMediaPlayer extends android.media.MediaPlayer {
    ...
    private Station mStreamStation;
 
    public Station getStreamStation() {
     ...
     */
    public void setStreamStation(Station streamStation) {
     ...
     */
    public StatefulMediaPlayer(Station streamStation) {
        super();
